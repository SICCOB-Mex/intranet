    ...
    setTimeout(() => {
        ...
        msgBot.innerHTML = `
            ...
            3️⃣ <b>Paso 3:</b> Busca la carpeta A1SETUP e ingresa a ella.<br>
             <img src="Carpeta1.png" style="width: 60%; border-radius: 6px; margin: 8px 0; box-shadow: 0 2px 5px rgba(0,0,0,0.1);" alt="sistemas$"></p><br>
            4️⃣ <b>Paso 4:</b> Ejecuta el Setup Admin One Client Installer.<br>
            <img src="a1.png" style="width: 60%; border-radius: 6px; margin: 8px 0; box-shadow: 0 2px 5px rgba(0,0,0,0.1);" alt="sistemas$"></p><br>
