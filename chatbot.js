...
function ejecutarPasosA1() {
    ...
    setTimeout(() => {
        ...
        msgBot.innerHTML = `
            ...
            1️⃣ <b>Paso 1:</b> <p> Preciona Win + R, para abrir el ejecutar.
            <img src="sistema$.png" style="width: 100%; border-radius: 6px; margin: 8px 0; box-shadow: 0 2px 5px rgba(0,0,0,0.1);" alt="sistemas$"></p><br>
